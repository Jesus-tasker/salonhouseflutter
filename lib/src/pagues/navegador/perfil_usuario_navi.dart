...
void main() => runApp(Perfil_Usuario_navi());

class Perfil_Usuario_navi extends StatefulWidget {
  @override
  _Perfil_Usuario_naviState createState() => _Perfil_Usuario_naviState();
}
...
class _Perfil_Usuario_naviState extends State<Perfil_Usuario_navi> {
...
//5  worker
  ...
  Future<void> _completar_delivery(
    ...
    if (response.statusCode == 200) {
      ...
      try {
        ...
        _panel_steper_informar_worker_pedido_recibido(buyOrder, keyworker);
      } catch (e) {}
    } else {
  ...
  Future _panel_steper_informar_worker_pedido_recibido(
      String buyorder, String keyuid_worker) async {
    int i = 4;
    var busqueda2 = FirebaseFirestore.instance
        .collection('workers_rider')
        .doc("workers")
